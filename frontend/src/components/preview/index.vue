    ...
    <div class="preview-content">
      <div class="main-content">
        ...
        <div class="main-content-main">
          ...
          <!-- Read URL result -->
          <FileContent v-else-if="type === 'read_url'" :filePath="fileName || 'read_url'" :file-content="fileContent"/>
  ...
  switch (actionType) {
    ...
    case 'replace_code_block':
      ...
      if (!newValue.meta?.filepath) {
        console.warn(`Missing filepath in ${actionType} meta:`, newValue);
      }
    ...
    case 'read_url':
      ...
      // meta.json vient du runtime (tableau d'objets), ex: [{ title, final_url, status, ... }]
      fileName.value = Array.isArray(newValue.meta?.json) && newValue.meta.json[0]?.final_url
        ? (newValue.meta.json[0].final_url.split('?')[0] || '')
        : 'read_url';
