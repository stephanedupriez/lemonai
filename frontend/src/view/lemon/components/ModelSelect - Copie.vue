...
// IMPORTANT:
// Le fait d’avoir une prop `modelValue` déclarée ne veut pas dire qu’un v-model est branché.
// La seule façon fiable ici est de détecter le listener `onUpdate:modelValue`.
const attrs = useAttrs()
const hasExternalModel = computed(() => attrs['onUpdate:modelValue'] != null)
