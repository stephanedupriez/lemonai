      ...
      <div class="input-area">
		...
		<div class="model-selectors">
                  <div class="model-selector">
                    <span class="model-label">Modèle rapide</span>
                    <ModelSelect />
                  </div>
                  <div class="model-selector">
                    <span class="model-label">Modèle de raisonnement</span>
                    <ModelSelect v-model:modelValue="reasoning_model_id" />
                  </div>
                </div>
                <!-- 模式切换器 - 响应式 -->
...
const { agent, chat, model_id, reasoning_model_id } = storeToRefs(chatStore);
